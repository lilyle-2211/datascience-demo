...
from ....config.settings import AB_TEST_DEFAULTS
...
def render_ab_test_traffic_timeline():
    ...
    daily_users = st.number_input(
        ...
        min_value=100,
        max_value=1000000,
        value=AB_TEST_DEFAULTS["daily_users"],
        step=100,
    ...
    treatment_size = (
        st.slider(
            ...
            min_value=10,
            max_value=90,
            value=int(AB_TEST_DEFAULTS["treatment_allocation"] * 100),
            step=5,
    ...
    if "Z-test" in test_metric:
        current_rate = (
            st.number_input(
                ...
                min_value=0.1,
                max_value=99.9,
                value=AB_TEST_DEFAULTS["current_rate"] * 100,
                step=0.1,
        ...
        if "Absolute" in mde_type:
            mde = (
                st.number_input(
                    ...
                    min_value=0.1,
                    max_value=50.0,
                    value=AB_TEST_DEFAULTS["mde_absolute"] * 100,
                    step=0.1,
            ...
            relative_mde = st.number_input(
                ...
                min_value=1.0,
                max_value=500.0,
                value=AB_TEST_DEFAULTS["mde_relative"],
                step=1.0,
...
def render_ab_test_results():
    ...
    try:
        ...
        alpha = ab_params.get("alpha", AB_TEST_DEFAULTS["alpha"])
        power = ab_params.get("power", AB_TEST_DEFAULTS["power"])
        treatment_size = ab_params.get("treatment_size", AB_TEST_DEFAULTS["treatment_allocation"])
        daily_users = ab_params.get("daily_users", AB_TEST_DEFAULTS["daily_users"])
        ...
        if "Z-test" in test_metric:
            ...
            current_rate = ab_params.get("current_rate", AB_TEST_DEFAULTS["current_rate"])
            mde = ab_params.get("mde", AB_TEST_DEFAULTS["mde_absolute"])
